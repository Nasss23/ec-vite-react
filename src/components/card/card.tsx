      ...
      <Link to='/categories/:id' className='space-y-3'>
        ...
        <div className=''>
          ...
          <div className='flex items-center gap-2'>
            <span className='text-base leading-[26px] text-[#141718] font-semibold '>${price}.00</span>
            <span className='text-sm line-through leading-[26px] text-red-400 font-medium '>${discount}.00</span>
          </div>
        </div>
      </Link>
