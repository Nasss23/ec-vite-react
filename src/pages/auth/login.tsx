  ...
  return (
    <div className='flex justify-center'>
      <div className='space-y-9 w-[600px]'>
        ...
        <form onSubmit={handleSubmit(handleLogin)} className='space-y-3' autoComplete='off'>
          ...
          <div className='flex items-center justify-center gap-2'>
            <p className='text-sm font-medium leading-5 text-base-500'>Don’t have an account?</p>
            <Link to='/auth/register' className='text-base font-bold leading-5 underline text-select'>
              Sign up
            </Link>
          </div>
        </form>
